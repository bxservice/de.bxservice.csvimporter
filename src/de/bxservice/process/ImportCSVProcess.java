...
public class ImportCSVProcess extends SvrProcess implements DataStatusListener{
	...
	protected String doIt() throws Exception {
		...
		try {
			initGridTab();
			GridTabCSVImporter csvImport = new GridTabCSVImporter();
	...
	protected void initGridTab() throws Exception {
		...
		asynchronousCommit = m_importTemplate.get_ValueAsBoolean("BAY_AsyncCommits");
	...
	protected void importFile(String filePath, GridTabCSVImporter csvImporter, GridTab activeTab, List<GridTab> childTabs) throws Exception {
		m_file_istream = new FileInputStream(filePath);
		csvImporter.setAsynchronousCommit(asynchronousCommit);
